...
# Taken from https://github.com/facebookresearch/kill-the-bits/blob/mask_r_cnn/src/utils/coco_eval.py
...
def evaluate(self):
    ...
    if isinstance(self.evalImgs, defaultdict):
        self.evalImgs = []
    self.evalImgs.extend(evalImgs)
